...
export class HouseRemovalsComponent implements OnInit, OnDestroy {
  ...
  setInitialPageConfiguration(): void {
    ...
    const canonicalUrl = `https://www.floand-go.com/${this.currentLanguage}/house-removals`;
    ...
    this.updateMetaTag('keywords', 'mudanças casa, mudanças lisboa, empresa de mudanças, Flo and Go');
    ...
    this.updateMetaProperty('og:image:alt', 'Logo da empresa Flo and Go - mudanças em Lisboa');
