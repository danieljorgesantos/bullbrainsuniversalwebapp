...
export class AvailableAnytimeMovingServicesComponent {
  // Language
  ...
  setInitialPageConfiguration() {
    const titleToSet = avaiableAnytimeTranslations[this.currentLanguage]?.meta_title || avaiableAnytimeTranslations['en']?.meta_title;
    const descriptionToSet = avaiableAnytimeTranslations[this.currentLanguage]?.meta_description || avaiableAnytimeTranslations['en']?.meta_description;
