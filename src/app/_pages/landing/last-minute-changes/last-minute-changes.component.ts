...
export class LastMinuteChangesComponent {
// Language
  ...
  setInitialPageConfiguration() {
    const titleToSet = lastMinuteChangesTranslations[this.currentLanguage]?.meta_title || lastMinuteChangesTranslations['en']?.meta_title;
    const descriptionToSet = lastMinuteChangesTranslations[this.currentLanguage]?.meta_description || lastMinuteChangesTranslations['en']?.meta_description;
