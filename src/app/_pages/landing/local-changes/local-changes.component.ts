...
export class LocalChangesComponent implements OnInit, OnDestroy {
  ...
  setInitialPageConfiguration(): void {
    ...
    const canonicalUrl = `https://www.floand-go.com/${this.currentLanguage}/local-changes`;
    ...
    this.updateMetaTag('keywords', 'mudanças locais, mudanças em Lisboa, empresa de mudanças, Flo and Go');
    ...
    this.updateMetaProperty('og:image:alt', 'Logo da empresa Flo and Go - mudanças locais');
